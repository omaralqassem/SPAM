...
setInterval(() => {
  http.get(`http://colossal-scarer.glitch.me/`);
}, 280000);
...
const initcmd = "-";
const serverid = "662313022487920675";
const roomid = "667078320697114634";
...
client14.on("ready", () => {
  console.log(`[Kahrbaa] : الحساب رقم 14يعمل`);
  console.log(`Hi ${client14.user.tag} , This Code by : Kahrbaa `);
  console.log(`i Have  [ " ${client14guilds.size} " ]`);
});
client15.on("ready", () => {
  console.log(`[Kahrbaa] : الحساب رقم 15يعمل`);
  console.log(`Hi ${client15.user.tag} , This Code by : Kahrbaa `);
  console.log(`i Have  [ " ${client15guilds.size} " ]`);
});
client16.on("ready", () => {
...
client12.login(settings.token12);
client13.login(settings.token13);
client14.login(settings.token14);
client15.login(settings.token15);
client16.login(settings.token16);
client17.login(settings.token17);
client18.login(settings.token18);
client19.login(settings.token19);
client20.login(settings.token20);